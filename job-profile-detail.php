...
$sql = "SELECT * FROM tbl_job j INNER JOIN tbl_user2 u on u.id_user=j.id_user WHERE job_id = '$job_id'";
...
<section class="search-result-list-detail template-2">
    <div class="container">
        <div class="row no-gutters">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="btn_apply" style="padding: 10px;" class="el-button btn-call-action el-button--warning">Nộp Đơn</button>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
            ...
            <?php
            $list_job = "SELECT job.job_id, u.user_name,job.tencv,job.hinhanh,job.khuvuc,job.muc_luong,job.hinhthuc_lv,job.ngay_dang  
                    FROM tbl_job as job
