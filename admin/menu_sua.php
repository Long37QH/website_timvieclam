<?php
    ...
    $sua_sql = "SELECT * FROM menu WHERE menu_id = '$maMenu'";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Sửa thanh menu</h4>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" method="post" action="">
                                <div class="card-body">
                                    <h4 class="card-title">Cập Nhật thông tin menu</h4>
                                    <div class="form-group row">
                                        <label for="tenMenu" class="col-sm-3 text-end control-label col-form-label">Tên Menu</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="tenMenu" name="tenMenu" value="<?php echo $row['tenMenu'] ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="vitri" class="col-sm-3 text-end control-label col-form-label">Vị Trí</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="vitri" name="vitri" value="<?php echo $row['vitri'] ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="capmenu" class="col-sm-3 text-end control-label col-form-label">Cấp menu</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="capmenu" name="capmenu" value="<?php echo $row['capmenu'] ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group row">
...
<?php 
    ...
    if(isset($_POST['capnhat'])){
            ...
            $editsql = "UPDATE menu SET tenMenu = '$tenMenu' , vitri = '$vitri' ,capmenu = '$capmenu',trangthaiAH = '$trangthaiAH',link = '$link'  WHERE menu_id = '$maMenu';";
