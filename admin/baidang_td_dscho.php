                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            $list_ds = "SELECT job_id,user_name, tencv,hinhthuc_lv,hinhanh,khuvuc,trangthaibai FROM tbl_job j INNER JOIN tbl_user u ON j.id_user = u.id_user WHERE trangthaibai = 'Chờ phê duyệt';";
