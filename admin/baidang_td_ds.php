...
if (isset($_POST["loc"])) {
    ...
    WHERE trangthaibai = 'Phê duyệt' and (user_name = '$user_name' or khuvuc = '$khuvuc' or hinhthuc_lv = '$hinhthuc_lv' );";
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 150px;"><strong>Tên Công ty</strong></th>
                                        <th style="width: 100px;"><strong>Vị trí </strong></th>
                                        <th style="width: 100px;"><strong>Hình ảnh</strong></th>
                                        ...
                                        <th style="width: 80px;"><strong>Chức năng</strong></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($data as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('bạn có muốn xoá không ?');" class="btn btn-danger" href="baidang_td_xoa.php?sid=<?php echo $row['job_id']; ?>"> <i class="fas fa-trash-alt"></i> Xoá bài </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tfoot>
