...
if (isset($_POST["login"])) {
    ...
    $query = "SELECT * FROM tbl_user WHERE tentk='$tkungvien' AND pass='$pass' AND loaitk ='$role'";
    //echo $query;exit;
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="pwd" type="password" name="pass" placeholder="enter your password">
                                    </div>
                                    <p style="color: red;">
                                        <?php
